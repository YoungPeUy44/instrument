...
if ($act == 'manual_guide') {
      ...
      include($_SERVER['DOCUMENT_ROOT'] . '/xct/instrument/add_instrument.php');  // ป๋วย ดึงเข้า XCT menu Guide (ยกเลิกใช้งาน) 
} else if ($act == 'back_index') {
      include($_SERVER['DOCUMENT_ROOT'] . '/xct/instrument/index.php');  // เต้ ทดสอบโหลดฟอร์ม bb 
} else if ($act == '__') {
